...
public class Users {
    ...
    public static User getUser(String login){
        ...
        try {
            ResultSet resultSet = getConnectionProvider().getConnection().createStatement().executeQuery("select * from users where login='" + login + "'"); // TODO: use prepared statements  ( '; drop table lol;-- )
            if(resultSet.next()){
